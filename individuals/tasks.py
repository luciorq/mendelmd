...
def parse_vcf(line):
    ...
    if 'CLASS' in information:
        variant['hgmd_class'] = information['CLASS']
    else:
        variant['hgmd_class'] = None

    if 'PHEN' in information:
        variant['hgmd_phen'] = information['PHEN']
    else:
        variant['hgmd_phen'] = None

    if 'OM' in information:
